<template>
  <v-row>
    <v-col class="text-center">
      ...
      <RedBoxCards :symbols="KF_DEFAULT_SYMBOLS" localStoragePrefix="VOD"/>
    </v-col>
  </v-row>
</template>
